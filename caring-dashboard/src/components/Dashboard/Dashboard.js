...
const Dashboard = ({ user }) => {
  ...
  useEffect(() => {
    ...
    axios
    .get('https://8p4d6k6qei.execute-api.ap-south-1.amazonaws.com/dev/user/expression/average_time/' + id)
    .then(data => {
  ...
  useEffect(() => {
    ...
    let array = [];
    axios
      .get('https://8p4d6k6qei.execute-api.ap-south-1.amazonaws.com/dev/user/expression/average_time/' + id, { params: { filter: fill } })
      .then(data => {
  ...
  useEffect(() => {
    ...
    const from = Number(fromEmotion);
    const to = Number(toEmotion);
    // console.log(from, to);
    //console.log(user.expression_arr.length);
    axios
    .get('https://8p4d6k6qei.execute-api.ap-south-1.amazonaws.com/dev/user/expression/average_day/' + id, { params: { from: from, to: to } })
    .then(data => {
      // setAvgDay(data.data);
  ...
  useEffect(() => {
    ...
    const from = Number(fromValenceEmotion);
    const to = Number(toValenceEmotion);
    //console.log(user.expression_arr.length);
    axios
    .get('https://8p4d6k6qei.execute-api.ap-south-1.amazonaws.com/dev/user/valence/average_day/' + id, { params: { from: from, to: to } })
    .then(data => {
