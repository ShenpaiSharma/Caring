...
if (Status === 'register') {
  fetch('https://8p4d6k6qei.execute-api.ap-south-1.amazonaws.com/dev/user/expression', {
    method: 'post',
  ...
  fetch('https://8p4d6k6qei.execute-api.ap-south-1.amazonaws.com/dev/user/signin', {
    method: 'post',
    headers: {'Content-Type': 'application/json'},
    body: JSON.stringify({
      email: Email,
...
function updateExpression(expressions_array) {
  fetch('https://8p4d6k6qei.execute-api.ap-south-1.amazonaws.com/dev/user/update/expression', {
    method: 'put',
    headers: {'Content-Type': 'application/json'},
    body: JSON.stringify({
      user_id: user_id,
